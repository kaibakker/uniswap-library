...
var State = /** @class */ (function () {
    ...
    State.prototype.asVector = function () {
        return [this.eth.dividedBy(Math.pow(10, 18)).toNumber(), this.tokens.dividedBy(Math.pow(10, 18)).toNumber(), this.liquidity.dividedBy(Math.pow(10, 18)).toNumber()];
    };
