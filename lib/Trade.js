...
var Trade = /** @class */ (function () {
    ...
    Trade.prototype.plus = function (eth, tokens, liquidity) {
        ...
        return new Trade(this.delta.eth.plus(new bignumber_js_1.default(eth)), this.delta.tokens.plus(new bignumber_js_1.default(tokens)), this.delta.liquidity.plus(new bignumber_js_1.default(liquidity)));
    };
